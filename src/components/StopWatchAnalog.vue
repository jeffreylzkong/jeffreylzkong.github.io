...
<div class="fill">
  ...
  <div class="clock hand-style-hollow minute-display-style-fine minute-text-style-outside hour-style-text hour-text-style-small hour-display-style-all minute-style-line" id="utility-clock">
    <div class="centre">
        ...
        <div class="anchor minute">
            <div class="element thin-hand"></div>
            <div class="element thin-hand minute-hand"></div>
        </div>
...
export default {
  ...
  mounted(){
    ...
    var clock = this.$el.querySelector('#utility-clock')
  ...
  methods: {
    ...
    utilityClock: function(container) {
        ...
        var _this = this;
        var animateStopWatch = function(){
            rotate(secondElement, _this.milsec * 6 / 10   );
            rotate(minuteElement, _this.sec);
            rotate(hourElement, _this.min);
